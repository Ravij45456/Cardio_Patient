...
- (void)commonInit {
    ...
    _labelFont = [UIFont fontWithName:DEFAULT_FONT_NAME size:1];
    
    // Set Animation Values
    _animationGraphEntranceTime = 25;
    ...
    _colorTouchInputLine = [UIColor blueColor];
    _colorBackgroundPopUplabel = [UIColor whiteColor];
    _alphaTouchInputLine = 0.10;
    _widthTouchInputLine = 1.5;
    _colorBackgroundXaxis = nil;
    _alphaBackgroundXaxis = 1.5;
    _colorBackgroundYaxis = nil;
    _alphaBackgroundYaxis = 1.5;
...
//        NSLog(@"[BEMSimpleLineGraph] Data source contains no data. A no data label will be displayed and drawing will stop. Add data to the data source and then reload the graph.");
        ...
        self.noDataLabel.text = noDataText ?: NSLocalizedString(@"", nil);
#else
