...
// This file has properties that can be used to set the circular progress bar.
...
- (void)setupLayer {
    ...
    // MARK: Colour behind the circular progress.
    self.strokeColor = [UIColor colorWithRed:116/255.0 green:116/255.0 blue:116/255.0 alpha:1.0].CGColor;
...
- (double)percent {
    ...
    // MARK: Color of the progress bar is set.
    - (void)setProgressColor:(UIColor *)progressColor {
        self.progressLayer.strokeColor = [UIColor colorWithRed:25.0/255.0 green:61.0/255.0 blue:77.0/255.0 alpha:1.0].CGColor;
    }
